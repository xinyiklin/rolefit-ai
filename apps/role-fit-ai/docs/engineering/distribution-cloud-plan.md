...
npm run test:desktop:windows-installer --workspace apps/role-fit-ai -- --installer=apps/role-fit-ai/.forge/release/RoleFit-AI-0.1.0-windows-x64.exe
```
...
`RoleFit-AI-0.1.0-macos-arm64.dmg` and a local
