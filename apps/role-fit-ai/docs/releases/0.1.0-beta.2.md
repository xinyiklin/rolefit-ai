# RoleFit Local Companion 0.1.0 — unsigned preview beta.2
...
Beta.2 corrects the native Windows release probe that blocked beta.1 before any
Windows installer or GitHub Release was published.
