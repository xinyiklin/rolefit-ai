# RoleFit Local Companion 0.1.0 — unsigned preview beta.3
...
Beta.3 corrects the release-workflow path passed to the Windows installer
lifecycle smoke. Beta.2 built and smoke-launched the unsigned installer, but
publication remained blocked before the install/run/uninstall gate.
