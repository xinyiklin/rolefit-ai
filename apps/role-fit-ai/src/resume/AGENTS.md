...
- Do not calculate, recompute, or substitute a fit verdict, confidence,
  eligibility decision, or requirement coverage. Initial Fit owns the complete
  categorical fit judgment; invalid assessment output fails visibly.
