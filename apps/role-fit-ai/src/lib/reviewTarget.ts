...
import type { ResumeProposalTarget } from "../resume/types.ts";
...
// shared Typeset field.
export function fieldKeyForReviewTarget(data: ResumeData, target: ResumeProposalTarget | null): string | null {
