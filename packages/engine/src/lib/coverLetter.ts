...
export function parseCoverLetterStyle(value: unknown): CoverLetterStyle {
  ...
  return {
    ...
    marginTopPt: requireNumber(style.marginTopPt, "marginTopPt", 18, 108),
    marginRightPt: requireNumber(style.marginRightPt, "marginRightPt", 18, 108),
    marginBottomPt: requireNumber(style.marginBottomPt, "marginBottomPt", 18, 108),
    marginLeftPt: requireNumber(style.marginLeftPt, "marginLeftPt", 18, 108)
  };
}
...
export function coverLetterResumeData(paragraphs: readonly string[]): ResumeData {
...
export function parseCoverLetterFile(
  ...
  requireExactKeys(document, ["paragraphs"], "invalid-document", "Cover-letter document");
  const paragraphs = validateParagraphs(document.paragraphs);
  return {
    data: coverLetterResumeData(paragraphs),
